    ...
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Sélectionnez une place disponible et confirmez votre réservation
        </p>
      </div>
            ...
            <div className="card-base p-4 bg-secondary/5 border-2 border-secondary space-y-3">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{selectedSpace.level}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Type</span>
                  <span className="font-semibold capitalize">{selectedSpace.type}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Prix/heure</span>
                  <span className="font-semibold">{selectedSpace.pricePerHour} €</span>
                </div>
              </div>
                ...
                <div className="pt-3 border-t border-border space-y-2">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {selectedSpace.features.map(feature => (
                      <span key={feature} className="text-xs bg-primary/10 text-primary px-2 py-1 rounded capitalize">
                        {feature}
                      </span>
                    ))}
                  </div>
