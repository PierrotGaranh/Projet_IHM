  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <QuickActionCard href="/dashboard/booking" icon={<span className="text-2xl">P</span>} title="Réserver une place" description="Trouvez et réservez votre place de parking" />
        <QuickActionCard href="/dashboard/reservations" icon={<CheckLine className="w-5 h-5 text-secondary" />} title="Mes réservations" description="Consultez l'historique de vos réservations" />
      </div>
