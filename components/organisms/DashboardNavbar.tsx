...
export function DashboardNavbar({ isMobile, user, onLogout }: DashboardNavbarProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            ...
            {!isMobile && (
              <ActiveLink href="/home" className="flex items-center gap-2 hover:opacity-80 transition-opacity ml-2 sm:ml-0">
