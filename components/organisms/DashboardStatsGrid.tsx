...
export function DashboardStatsGrid({ activeReservations, availableSpaces, occupancyRate, totalRevenue }: DashboardStatsGridProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <DashboardStatCard title="Places disponibles" value={availableSpaces} icon={<BarChart3 className="w-5 h-5" />} color="accent" description="Répartis sur différent location" />
